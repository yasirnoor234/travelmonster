			...
			<ul class="wpte-list">
				...
				if ( isset( $order_trip->end_datetime ) && $order_trip->end_datetime ) :
					...
					<li>
						...
						<span>
							<div class="wpte-field wpte-text">
								<input type="text" placeholder="YYYY-MM-DD" readonly data-attrib-name="order_trips[<?php echo esc_attr( $cart_id ); ?>][end_datetime]" data-attrib-value="<?php echo esc_attr( $order_trip->end_datetime ); ?>" value="<?php echo esc_attr( wp_date( $date_format, strtotime( $order_trip->end_datetime ) ) ); ?>"/>
							</div>
						</span>
					</li>
				<?php endif; ?>
